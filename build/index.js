...
import { handleListRecipes, handleGetRecipe, handleCreateRecipe, handleUpdateRecipe, } from './handlers/recipe.js';
import { handleListMealPlans, handleGetMealPlan, handleCreateMealPlan, handleUpdateMealPlan, handleDeleteMealPlan, handleAutoMealPlan, handleListMealTypes, } from './handlers/mealplan.js';
import { handleListFoods, handleGetFood, handleUpdateFood, handleDeleteFood, handleMergeFoods, } from './handlers/food.js';
import { handleListKeywords, handleGetKeyword, handleUpdateKeyword, handleDeleteKeyword, } from './handlers/keyword.js';
import { handleListSupermarketCategories, handleCreateSupermarketCategory, handleUpdateSupermarketCategory, handleDeleteSupermarketCategory, } from './handlers/supermarket.js';
import { handleListShoppingList, handleAddShoppingListEntry, handleUpdateShoppingListEntry, handleDeleteShoppingListEntry, handleBulkCheckShoppingList, } from './handlers/shopping.js';
import { handleListUnits, handleMergeUnits, } from './handlers/unit.js';
    ...
    try {
        ...
        switch (name) {
            ...
            case 'list_recipes':
                ...
                break;
            case 'get_recipe':
                text = await handleGetRecipe(tandoorClient, args);
                break;
            case 'create_recipe':
            ...
            case 'list_meal_plans':
                ...
                break;
            case 'get_meal_plan':
                text = await handleGetMealPlan(tandoorClient, args);
                break;
            ...
            case 'delete_meal_plan':
                text = await handleDeleteMealPlan(tandoorClient, args);
                break;
            case 'auto_meal_plan':
            ...
            case 'list_foods':
                ...
                break;
            case 'get_food':
                text = await handleGetFood(tandoorClient, args);
                break;
            case 'update_food':
                text = await handleUpdateFood(tandoorClient, args);
                break;
            case 'delete_food':
                text = await handleDeleteFood(tandoorClient, args);
                break;
            case 'merge_foods':
                text = await handleMergeFoods(tandoorClient, args);
                break;
            // Keyword tools
            case 'list_keywords':
                ...
                break;
            case 'get_keyword':
                text = await handleGetKeyword(tandoorClient, args);
                break;
            case 'update_keyword':
                text = await handleUpdateKeyword(tandoorClient, args);
                break;
            case 'delete_keyword':
                text = await handleDeleteKeyword(tandoorClient, args);
                break;
            ...
            case 'delete_supermarket_category':
                text = await handleDeleteSupermarketCategory(tandoorClient, args);
                break;
            // Shopping list tools
            ...
            case 'delete_shopping_list_entry':
                text = await handleDeleteShoppingListEntry(tandoorClient, args);
                break;
            case 'bulk_check_shopping_list':
                text = await handleBulkCheckShoppingList(tandoorClient, args);
                break;
            // Unit tools
            case 'list_units':
                ...
                break;
            case 'merge_units':
                text = await handleMergeUnits(tandoorClient, args);
                break;
            default:
